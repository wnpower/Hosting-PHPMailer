...
try {
    ...
    $mail->SMTPAuth = true;
    $mail->Username = 'remitente@tudominio.com';                 // Usuario SMTP
    $mail->Password = 'MiPa33W0rD';                           // Password SMTP
    $mail->SMTPSecure = 'tls';                            // Activar seguridad TLS
    $mail->Port = 587;                                    // Puerto SMTP
 
    $mail->setFrom('remitente@tudominio.com');		// Mail del remitente
    $mail->addAddress('destinatario@dominio.com');     // Mail del destinatario
